...
# Import internals
from .buttons import IconButton, OkButton
...
class RunToolFrame(tk.Frame):
    def __init__(self, master=None, **kwargs):
        ...
        self.helptitle = tk.Label(self.helpscreen, text="Help Screen",
                                  **style_options_titles)
        ...
        self.maintitle = tk.Label(self.mainscreen, text="User Input",
                                  **style_options_titles)
        self.maintitle.pack()
    ...
    def add_option_input(self, label, valuetype, argname=None, multi=False,
                         length=None, default=None, minval=None, maxval=None, choices=None):
        ...
        if multi:
            ...
            inputlabel = tk.Label(optionrow, text=label,
        ...
        # remember for later
        inputwidget.meta = dict(argname=argname, label=label,
                                choices=choices,
                                valuetype=valuetype,
                                multi=multi,
                                length=length,
                                default=default, minval=minval,
                                maxval=maxval)
